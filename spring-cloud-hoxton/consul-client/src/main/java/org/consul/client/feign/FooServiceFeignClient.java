package org.consul.client.feign;

import org.consul.client.entity.Person;
import org.consul.client.feign.fallback.FooServiceFallback;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.*;

@FeignClient(name = "consul-foo-service", fallback = FooServiceFallback.class)
